# Use Case 2: Semantic Search and Sentiment Analysis using pgvector, Aurora PostgreSQL and Aurora Machine Learning (Aurora ML)
1. [Overview](#overview)
...
![Architecture](static/usecase2_sentiment_analysis.png)
